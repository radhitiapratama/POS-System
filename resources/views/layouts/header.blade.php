        ...
        <div class="header-content-right">
            ...
            <div class="header-element country-selector">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                    <img src="/noa-assets/assets/images/flags/us_flag.jpg" alt="img" class="header-link-icon">
                </a>
                <!-- End::header-link|dropdown-toggle -->
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="/noa-assets/assets/images/flags/us_flag.jpg" alt="img">
                            </span> English
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="/noa-assets/assets/images/flags/spain_flag.jpg" alt="img">
                            </span>
                            Spanish
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="/noa-assets/assets/images/flags/french_flag.jpg" alt="img">
                            </span>
                            French </a>
                    </li>
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="/noa-assets/assets/images/flags/germany_flag.jpg" alt="img">
                            </span>
                            German
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="/noa-assets/assets/images/flags/italy_flag.jpg" alt="img">
                            </span>
                            Italian
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-xs lh-1 me-2">
                                <img src="/noa-assets/assets/images/flags/russia_flag.jpg" alt="img">
                            </span>
                            Russian
                        </a>
                    </li>
            ...
            <div class="header-element header-theme-mode">
                ...
                <a aria-label="anchor" href="javascript:void(0);" class="header-link layout-setting">
                    <span class="light-layout"> <!-- Start::header-link-icon -->
            ...
            <div class="header-element header-shortcuts-dropdown">
                <!-- Start::header-link|dropdown-toggle -->
                <a aria-label="anchor" href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="notificationDropdown" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" class="header-link-icon">
                ...
                <div class="main-header-dropdown header-shortcuts-dropdown dropdown-menu pb-0 dropdown-menu-end" aria-labelledby="notificationDropdown">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0 fs-15">SHORTCUTS</p>
                            <div class="btn-list">
                                <button type="button" aria-label="button" class="btn btn-icon btn-sm btn-outline-primary">
                    ...
                    <div class="px-2 py-2">
                        <div class="row mb-2">
                            <div class="col d-flex">
                                <a href="vector-maps.html" class="related-app">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-center source-logo" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                    ...
                                    <span class="mt-1 source-title">Maps</span>
                                </a>
                            </div>
                            <div class="col d-flex">
                                <a href="full-calendar.html" class="related-app">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-center source-logo" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex">
                                <a href="blog.html" class="related-app">
                                    ...
                                    <span class="mt-1 source-title">Blog</span>
                                </a>
                            </div>
                            <div class="col d-flex"> <a href="form_inputs.html" class="related-app"> <svg xmlns="http://www.w3.org/2000/svg" class="text-center source-logo" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                    ...
                                    <span class="mt-1 source-title">Forms</span> </a> </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="header-element header-fullscreen">
                ...
                <a aria-label="anchor" onclick="openFullscreen();" href="javascript:void(0);" class="header-link">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" class="full-screen-open header-link-icon">
            ...
            <div class="header-element cart-dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                    ...
                    <span class="badge bg-info header-icon-badge" id="cart-icon-badge">5</span>
                </a>
                <!-- End::header-link|dropdown-toggle -->
                <!-- Start::main-header-dropdown -->
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0 fs-15">Shopping Cart</p>
                            <a href="javascript:void(0);">
                                <span class="badge bg-info-transparent" id="cart-data">5 Items</span>
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="simplebar-content" style="padding: 0px;">
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/ecommerce/1.jpg" alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                                <a href="cart.html">TrueBasket Metal Single
                                                                    Pot</a>
                                                            </div>
                                                            <div>
                                                                <span class="text-dark mb-1 fs-16 fw-semibold">$129</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status:
                                                                <span class="text-primary">In Stock
                                                                </span>
                                                            </span>
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 01 <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove float-end dropdown-item-close">
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/ecommerce/2.jpg" alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                                <a href="cart.html">Authentic chair with
                                                                    Canopy</a>
                                                            </div>
                                                            <div>
                                                                <span class="text-dark mb-1 fs-16 fw-semibold">$99</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status:
                                                            ...
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 03
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/ecommerce/3.jpg" alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                                <a href="cart.html">Casual Sneakers Canvas</a>
                                                            </div>
                                                            <div>
                                                                <span class="text-dark mb-1 fs-16 fw-semibold">$299</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status: <span class="text-primary">In Stock</span>
                                                            </span>
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 01 <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove float-end dropdown-item-close">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/ecommerce/4.jpg" alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                                <a href="cart.html">Branded Head Phones</a>
                                                            </div>
                                                            <div>
                                                                <span class="text-dark mb-1 fs-16 fw-semibold">$249</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12"> <span class="fw-normal">Status: <span class="text-danger">Out of
                                                                    Stock</span>
                                                            </span>
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 01
                                                                <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove float-end dropdown-item-close"><i class="ti ti-trash"></i>
                                                                </a>
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="dropdown-item p-3">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/ecommerce/5.jpg" alt="img" class="avatar avatar-lg me-2">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                                <a href="cart.html">camera lens (16mm
                                                                    f/1.4)</a>
                                                            </div>
                                                            <div>
                                                                <span class="text-dark mb-1 fs-16 fw-semibold">$1,279</span>
                                                            </div>
                                                        </div>
                                                        <div class="text-muted fs-12">
                                                            <span class="fw-normal">Status: <span class="text-primary">In Stock</span>
                                                            </span>
                                                            <p class="mb-0 fw-normal text-gray">Quantity: 02
                                                                <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove float-end dropdown-item-close"><i class="ti ti-trash"></i>
                                                                </a>
                                                            </p>
                                                        </div>
                    ...
                    <div class="dropdown-divider"></div>
                    <div class="dropdown-footer empty-header-item">
                        <a href="checkout.html" class="dropdown-footer btn btn-primary my-0">Checkout</a>
                    </div>
                    <div class="py-5 px-4 empty-item d-none">
                        <div class="text-center">
                            <span class="avatar avatar-xl avatar-rounded bg-warning-transparent">
                                <i class="ri-shopping-cart-2-line fs-2"></i>
                            </span>
                            <h6 class="fw-bold mb-1 mt-3">Nothing Here!</h6>
                            <span class="mb-3 fw-normal fs-13 d-block">Looks like you haven't added anything
                                yet...
                                <i class="fa fa-smile"></i>
                            </span>
                            <a href="products.html" class="btn btn-primary btn-wave btn-sm m-1 waves-effect waves-light" data-abc="true">Continue Shopping
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0);">
                                <span class="badge bg-secondary-transparent">4 Messages
                                </span>
                            </a>
                        </div>
                    </div>
                    <div class="dropdown-divider"></div>
                    <ul class="list-unstyled mb-0" id="header-message-items-scroll" data-simplebar="init">
                        <div class="simplebar-wrapper" style="margin: 0px;">
                            <div class="simplebar-height-auto-observer-wrapper">
                                <div class="simplebar-height-auto-observer"></div>
                            </div>
                                    ...
                                    <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;">
                                        <div class="simplebar-content" style="padding: 0px;">
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-center cart-dropdown-item">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/users/1.jpg" alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                        ...
                                                        <div class="text-muted">
                                                            <span class="fw-normal fs-12">Wanted to submit
                                                                project
                                                                by tomorrow....</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/users/15.jpg" alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                        ...
                                                        <div class="text-muted">
                                                            <span class="fw-normal fs-12">Planning for ext big
                                                                update....</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/users/12.jpg" alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                                                        ...
                                                        <div class="text-muted">
                                                            <span class="fw-normal fs-12">Ready to submit future
                                                                data....</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        <img src="/noa-assets/assets/images/users/4.jpg" alt="img" class="avatar avatar-md me-3">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-start justify-content-between mb-0">
                                                            <div class="mb-0 fs-13 text-dark w-75">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0);">
                                <span class="badge bg-secondary-transparent" id="notification-data">4
                                    Notifications</span>
                            </a>
                        </div>
                    </div>
                                                ...
                                                <div class="d-flex align-items-start">
                                                    <div class="pe-2">
                                                        <span class="avatar avatar-md bg-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" class="source-logo2">
                                                                <path d="M17.4541016,11H6.5458984c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h10.9082031c0.276123,0,0.5-0.223877,0.5-0.5S17.7302246,11,17.4541016,11z M19.5,2h-15C3.119812,2.0012817,2.0012817,3.119812,2,4.5v11c0.0012817,1.380188,1.119812,2.4987183,2.5,2.5h12.7930298l3.8534546,3.8535156C21.2402344,21.9473267,21.3673706,22,21.5,22c0.276123,0,0.5-0.223877,0.5-0.5v-17C21.9987183,3.119812,20.880188,2.0012817,19.5,2z M21,20.2929688l-3.1464844-3.1464844C17.7597656,17.0526733,17.6326294,17,17.5,17h-13c-0.828064-0.0009155-1.4990845-0.671936-1.5-1.5v-11C3.0009155,3.671936,3.671936,3.0009155,4.5,3h15c0.828064,0.0009155,1.4990845,0.671936,1.5,1.5V20.2929688z M17.4541016,8H6.5458984c-0.276123,0-0.5,0.223877-0.5,0.5s0.223877,0.5,0.5,0.5h10.9082031c0.276123,0,0.5-0.223877,0.5-0.5S17.7302246,8,17.4541016,8z">
                                                                </path>
                                                            </svg>
                                                        </span>
                                                    ...
                                                    <div class=" d-flex flex-fill align-items-center justify-content-between">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">
                                                                <a href="mail-inbox.html" class="text-gray">New
                                                                    Message Received</a>
                                                            </p>
                                            ...
                                            <li class="dropdown-item p-3 border-bottom">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex flex-fill align-items-center justify-content-between">
                                                        ...
                                                        <div> <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-muted me-1 dropdown-item-close1">
                                                                <i class="ti ti-x fs-16">
                                                                </i>
                                                            </a>
                                                        </div>
                                                    </div>
            ...
            <div class="header-element">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <img src="/noa-assets/assets/images/faces/6.jpg" alt="img" width="32" height="32" class="rounded-circle">
                        </div>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex" href="profile.html">
